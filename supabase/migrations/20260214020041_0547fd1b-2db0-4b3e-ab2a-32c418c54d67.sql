...
BEGIN
  ...
  IF user_role = 'client' THEN
    ...
    INSERT INTO public.client_profiles (user_id, company_name, contact_name, email, phone, domain_activity, account_status)
    VALUES (NEW.id, user_full_name, user_full_name, NEW.email, user_phone, COALESCE(user_domain, ''), 'pending')
